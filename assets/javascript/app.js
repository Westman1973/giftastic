$(document).ready(function(){
    ...
    var animals = [''];
        ...
        $('#theButton').on('click', function(){
            ...
            var newButton = $("<button/>").addClass( "btn-inf-button").attr('data-name',animalButton).html(animalButton).css({'margin': '5px'});
            ...
            var results = response.data;
                ...
                for (var i = 0; i < results.length; i++) {
                    ...
                    animalPic.attr('src', results[i].images.fixed_height_still.url);
